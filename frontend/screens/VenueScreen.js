                ...
                <View style={s.showBody}>
                  ...
                  <View style={s.seatsRow}>
                    <Ionicons
                      name="ticket-outline"
                      size={12}
                      color={show.available_seats === 0 ? "#e53e3e" : "#22c55e"}
                    />
                    <Text
                      style={[
                        s.seatsText,
                        show.available_seats === 0 && s.seatsTextFull,
                      ]}
                    >
                  ...
                  <TouchableOpacity
                    style={[
                      s.bookBtn,
                      show.available_seats === 0 && s.bookBtnDisabled,
                    ]}
                    activeOpacity={show.available_seats === 0 ? 1 : 0.85}
                    onPress={() =>
                      show.available_seats > 0 && onNavigateBook(show)
                    }
                  >
